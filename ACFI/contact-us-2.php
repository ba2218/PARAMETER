...
<div class="container">
    ...
    <div class="column two-thirds">
    	<div class="breadcrumbs"><a href="index.php">HOME</a>&gt; <a href="about-us.php">ABOUT US</a>&gt;<a href="contact-us.php">CONTACT US</a> &gt;CONTACT CONTINUED</div>       
...
$(document).ready(function() {
	$('.side-nav a[href="contact-us-2.php"]').addClass('active');
	$('.side-nav a[href="contact-us-2.php"]').removeAttr("href");
});
