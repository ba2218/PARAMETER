...
<div class="container">
    ...
    <!-- <p>Click to learn more about our residential product offerings:</p>-->
    ...
    <div class="txt-3">Let Devaney Energy Deliver</div>
        <p>Residential customers can enjoy several Devaney Energy services:</p>
        
    
        
        <ul class="content-list">
        <li>Automatic delivery of heating oil and propane</li>
        <li>Competitive electricity supply rates</li>
        <li>Professional installation of heating oil, natural gas and propane equipment</li>
        <li>Expert servicing of heating oil, natural gas and propane equipment</li>
        <li>Convenient payment options and plans</li>
        </ul>
    </div>
...
$(document).ready(function() {
	$('.side-nav a[href="residential-interests.php"]').addClass('active');
	$('.side-nav a[href="residential-interests.php"]').removeAttr("href");
});
</script>
