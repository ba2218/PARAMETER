...
<div class="container">
    ...
    <div class="column two-thirds">
    	<div class="breadcrumbs"><a href="index.php">HOME</a>&gt; COMMERCIAL CREDIT APPLICATION</div>
        
			<div class="txt-3">Commercial Charge Account Application</div>
            <p class="txt-2">Please tell us who you are:</p>
			
			<form method="post" action="http://pbldev.pixelbridge.com/devaney/formmail.php" onSubmit="return submitIt(this)" name="comForm">
            <input type="hidden" name="env_report" value="REMOTE_HOST,REMOTE_ADDR,HTTP_USER_AGENT,AUTH_TYPE,REMOTE_USER" />
            
<input type="hidden" name="recipients" value="bruce.kofi@gmail.com" />
